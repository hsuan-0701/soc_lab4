...
void __attribute__ ( ( section ( ".mprjram" ) ) ) config_set(int data_len ) {
 ...
 (*(volatile uint32_t*)(0x30000010)) = data_len ;
}

void __attribute__ ( ( section ( ".mprjram" ) ) ) tap_write(void){
 int taps[11] = { -6, 1, -7, 7, -1, -8, 3, 7, -10, -6, 8 };
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) fir_work(int data_len){
 ...
 if((*(volatile uint32_t*)(0x30000000)) == 4) (*(volatile uint32_t*)(0x30000000)) = 1;
 else (*(volatile uint32_t*)0x2600000c) = 0xABFF0000;
 ...
 for(int i=3 ; i < data_len ; i++){
   (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*)0x30000044) ;

   (*(volatile uint32_t*)0x30000040) = i;
    }
   (*(volatile uint32_t*)0x2600000c) = 0xAB470000;
}
