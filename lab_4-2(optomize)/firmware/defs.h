...
#define reg_fir_config_data_len (*(volatile uint32_t*)(0x30000010))
#define reg_fir_config_tap_num  (*(volatile uint32_t*)(0x30000014))
#define reg_fir_coeff(i)        (*(volatile uint32_t*)(0x30000080 + 4*(i)))
